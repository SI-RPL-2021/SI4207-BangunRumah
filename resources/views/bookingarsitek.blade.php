...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color:#F0F8FF">
  <div class="container-fluid">
    ...
    <div class="jumbotron" style="background-image:url('img/5e7ad933cdcaa.jpg')">
    <h1 style="color:white;text-align:center;font-family:helvetica">Find Your Architect!</h1>
    <p style="color:white;text-align:center;font-family:helvetica">You can start searching by filtering about yout main interest home design,home style.</p>
...
<br>
    ...
    <div class="row">
        <div class="col-sm">
            <div class="card " style="width: 18rem;background-color:#F0F8FF;border-radius: 10px;margin-left:25px">
                <div class="card-body">
                <form class="d-flex">
                    <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" style="background-color:lightgray">
        ...
        <div class="card mb-3" style="max-width: 540px; margin-right:20px; background-color:#F0F8FF">
            <div class="row g-0">
                <div class="col-md-4">
                <br>
                <img src="img/desain.jpeg" style="width:180px;height:180px">
                </div>
                <div class="col-md-8">
                <div class="card-body">
                <br>
                    <h5 class="card-title">AZ Architecture and Interiors</h5>
                    <p>
                    <i class="fas fa-map-marker-alt"></i>  Jl. Merdeka Barat </p>
                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                    <br><br>
                    <div class="d-grid gap-2 col-6 mx-auto" style="background-color: #0059C1;">
