...
<head>
    ...
    <title>Booking: Desain Interior</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-light" style="background-color:#F0F8FF">
  <div class="container-fluid">
    ...
    <div class="jumbotron" style="background-image:url('img/design.jpg')">
    <h1 style="color:white;text-align:center;font-family:helvetica">Booking Our Designers!</h1>
...
<br>
    ...
    <div class="row">
        <div class="col-sm">
            <div class="card " style="width: 18rem;background-color:#CECBCF;border-radius: 10px;margin-left:25px">
                <div class="card-body">
                <form class="d-flex">
                    <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" style="background-color:lightgray">
        ...
        <div class="card mb-3" style="max-width: 540px; margin-right:20px; background-color:#CECBCF">
            <div class="row g-0">
                <div class="col-md-4">
                <br>
                <img src="img/barang.jpeg" style="width:180px;height:180px">
                </div>
                <div class="col-md-8">
                <div class="card-body">
                <br>
                    <h5 class="card-title">T.U.D.I Studio</h5>
                    <p>
                    <i class="fas fa-map-marker-alt"></i>  Jl. Timur Raya </p>
                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                    <br><br>
                    <div class="d-grid gap-2 col-6 mx-auto" style="background-color: #775E7B;">
